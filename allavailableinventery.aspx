<%@ Page Title="" Language="C#" MasterPageFile="~/adminDashboard.master" AutoEventWireup="true" CodeFile="allavailableinventery.aspx.cs" Inherits="allavailableinventery" %>
      ...
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
	                                ...
	                                <div class="row">
									    <div class="col-xs-12">
										    ...
										    <div class="table-header">
											    Results for "Available invetory list"
										    </div>
            ...
            <AlternatingItemTemplate>
                    <tr style="">
                        ...
                        <td>
							<asp:LinkButton ID="AccountStatusLabel" runat="server" class="label label-sm invoice-info-label " CommandName="Edit" Text='<%# Eval("AccountStatus") %>' />
            ...
            <EditItemTemplate>
                ...
                <td>
                    <asp:LinkButton ID="AccountStatusLabel" runat="server" class="label label-sm invoice-info-label " CommandName="Update" Text='<%# Eval("AccountStatus") %>' />
                    ...
                    <tr style="">
                        ...
                        <td>
							<asp:LinkButton  runat="server"  CommandName="Edit"  >
                                    <asp:Label ID="AccountStatusLabel" runat="server" class="label label-sm invoice-info-label" Text='<%# Eval("AccountStatus") %>'></asp:Label>
							</asp:LinkButton>
                        ...
                        <td runat="server">
                            <table id="itemPlaceholderContainer" runat="server" class="table table-striped table-bordered table-hover">
                                <tr runat="server" style="">
                                    ...
                                    <th runat="server">Purchasing Date</th>
                                    <th runat="server">Purchasing Prize</th>
                                    <th runat="server">Labour</th>
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
             ...
             SelectCommand="sp_allavailableinventorylist" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
