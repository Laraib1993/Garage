<%@ Page Title="" Language="C#" MasterPageFile="~/adminDashboard.master" AutoEventWireup="true" CodeFile="allemployeelist.aspx.cs" Inherits="allemployeelist" %>
     ...
     <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            ...
            <AlternatingItemTemplate>
                    <tr style="">
                        ...
                        <td><asp:Label runat="server" ID="FullNameLabel" Text='<%# Eval("FullName") %>'>
                            </asp:Label>

                        </td>
                        <td>
                            <asp:Label runat="server" ID="joiningdateLabel" Text='<%# Eval("joiningdate") %>'>
                            </asp:Label>
                        ...
                        <td>
                            <asp:Label ID="AccountStatusLabel" runat="server" Text='<%# Eval("chargename") %>' />
                        </td>
                        <td>
                            <asp:LinkButton ID="lnkUpdate" class="label label-sm arrowed-in-right label-warning" CommandName="Edit" runat="server">
                            <asp:Label ID="chargenameLabel" runat="server" Text='<%# Eval("AccountStatus") %>' />
               ...
               <td>
                       ...
                       <td>
                        ...
                        <td>
                            ...
                            </asp:LinkButton></td></EditItemTemplate><EmptyDataTemplate>
                ...
                <table runat="server" class="col-lg-12 col-md-12">
                        ...
                        <td runat="server">
                            <table id="itemPlaceholderContainer" runat="server" class="table table-striped table-bordered table-hover">
                                <tr runat="server" style="">
                                     <th runat="server">
										 userinfoID</th><th runat="server">FullName</th><th runat="server">Joining Date</th><th runat="server">Email</th><th runat="server">CNIC</th><th runat="server">Mobile</th><th runat="server">Address</th><th runat="server">Designation</th><th runat="server">Salary</th><th runat="server">Status</th></tr><tr id="itemPlaceholder" runat="server">
                                </tr>
                            </table>
                        </td>
                    </tr>
                    <tr runat="server">
                        ...
                        <td>
                            <asp:LinkButton ID="lnkUpdate" class="label label-sm arrowed-in-right label-warning" CommandName="Edit" runat="server">
                            <asp:Label ID="chargenameLabel" runat="server" Text='<%# Eval("AccountStatus") %>' />
                            </asp:LinkButton></td></tr></SelectedItemTemplate>

                                                  </asp:ListView><asp:SqlDataSource ID="SqlDataSource1" runat="server" 
             ConnectionString="<%$ ConnectionStrings:workshopConnectionString  %>" 
             SelectCommand="sp_allemployeelist" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
