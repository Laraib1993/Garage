<%@ Page Title="" Language="C#" MasterPageFile="~/adminDashboard.master" AutoEventWireup="true" CodeFile="allneedinventery.aspx.cs" Inherits="allneedinventery" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    ...
                    <tr style="">
                        ...
                        <td>
							<asp:LinkButton  runat="server"  CommandName="Edit"  >
                                    <asp:Label ID="AccountStatusLabel" runat="server" class="label label-sm label-danger" Text='<%# Eval("AccountStatus") %>'></asp:Label>
							</asp:LinkButton>
                        </td>
                    </tr>
            </AlternatingItemTemplate>
            <EditItemTemplate>
                ...
                <td>
                    <asp:LinkButton ID="AccountStatusLabel" runat="server" class="label label-sm label-danger"  CommandName="Update" Text='<%# Eval("AccountStatus") %>' />
                        ...
                        <td runat="server">
                            <table id="itemPlaceholderContainer" runat="server" class="table table-striped table-bordered table-hover">
                                <tr runat="server" style="">
                                    ...
                                    <th runat="server">Last Purchasing Date</th>
                                    <th runat="server">Last Purchasing Prize</th>
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
             ...
             SelectCommand="sp_allneedinventorylist" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
