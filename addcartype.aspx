<%@ Page Title="" Language="C#" MasterPageFile="~/adminDashboard.master" AutoEventWireup="true" CodeFile="addcartype.aspx.cs" Inherits="addcartype" %>
										...
										<div class="widget-main">
                                           ...
                                           <asp:AsyncPostBackTrigger ControlID="listviewtable" EventName ="tick" />
                                                             ...
                                                             <div class="form-group">
																<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">Car Type:</label>

																<div class="col-xs-12 col-sm-9">
																	<div class="clearfix">
                                                                        <asp:TextBox ID="txtcartypename" runat="server" type="text" name="FullName" class="col-xs-12 col-sm-4"></asp:TextBox>
