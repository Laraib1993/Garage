<%@ Page Title="" Language="C#" MasterPageFile="~/adminDashboard.master" AutoEventWireup="true" CodeFile="allpendingcustomer.aspx.cs" Inherits="allpendingcustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div class="breadcrumbs ace-save-state" id="breadcrumbs">
	                                ...
	                                <div class="row">
									    <div class="col-xs-12">
										    ...
										    <div class="table-header">
											    Results for "All Pending Customer"
										    </div>
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
             ...
             SelectCommand="sp_allpendingcustomers" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
