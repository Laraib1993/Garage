<%@ Page Title="" Language="C#" MasterPageFile="~/adminDashboard.master" AutoEventWireup="true" CodeFile="allpendingemployee.aspx.cs" Inherits="allpendingemployee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
	                                ...
	                                <div class="row">
									    <div class="col-xs-12">
										    ...
										    <div class="table-header">
											    Results for "All Pending Employee List"
										    </div>
            ...
            <ItemTemplate>
             ...
             SelectCommand="sp_fetchallpendingemployeelist" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
