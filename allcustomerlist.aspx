<%@ Page Title="" Language="C#" MasterPageFile="~/adminDashboard.master" AutoEventWireup="true" CodeFile="allcustomerlist.aspx.cs" Inherits="allcustomerlist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            ...
            <AlternatingItemTemplate>
                ...
                <td>
                    <asp:Label ID="MobileTextBox" runat="server" Text='<%# Bind("Mobile") %>' />
                </td>
                <td>
                    <asp:Label ID="RoleNameTextBox" runat="server" Text='<%# Bind("RoleName") %>' />
                </td>
                <td>
         ...
         <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
             ...
             SelectCommand="sp_allcustomerlist" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
