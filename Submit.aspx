								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
                                           ...
                                           <asp:AsyncPostBackTrigger ControlID="listviewtable" EventName ="tick" />
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="clearfix">
                                                            ...
                                                            <asp:Button ID="btnLogin" type="button" class="width-35 pull-right btn btn-sm btn-primary bigger-110" runat="server" Text="Login" OnClick="btnLogin_Click" />
										...
										<div class="toolbar clearfix">
											<div>
												<a href="ForgetPassword.aspx" class="forgot-password-link">
											...
											<div>
												<a href="SignUp.aspx"  class="user-signup-link">
													I want to register
