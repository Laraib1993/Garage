                                                ...
                                                <fieldset>
                                                    <label class="block clearfix">
                                                        <span class="block input-icon input-icon-right">
                                                            ...
                                                            <asp:TextBox ID="txtUserName" runat="server" type="text" class="form-control" placeholder="User Name"></asp:TextBox>
                                                    ...
                                                    <div class="clearfix">
                                                        <asp:Button ID="btnSend" runat="server" Text="Send Me!" type="button" class="width-35 pull-right btn btn-sm btn-danger" OnClick="btnSend_Click" />
                                                    </div>
                                                </fieldset>
                                            </form>
										</div><!-- /.widget-main -->
